...
Singleton {
                ...
                try {
                    ...
                    if (content) {
                        ...
                        if (states.gameMode !== undefined) {
                            ...
                            // Apply if enabled
                            if (root.toggled) {
                                enableProcess.command = ["rctl", "config", "apply", "keyword animations:enabled 0; keyword decoration:shadow:enabled 0; keyword decoration:blur:enabled 0; keyword general:gaps_in 0; keyword general:gaps_out 0; keyword general:border_size 1; keyword decoration:rounding 0"];
    ...
    function toggle() {
        if (toggled) {
            disableProcess.command = ["rctl", "config", "reload"];
